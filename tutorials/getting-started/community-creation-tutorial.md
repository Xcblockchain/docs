...
description: >-
  ...
  the XCapital Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the XCapital network on your Metamask wallet before creating the community. Learn how to add XCapital network to Metamask using [this](https://docs.xcscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) tutorial.

Navigate to https://studio.xcscan.com/ and click on **“Login”** at the right hand top corner as shown below. Use your Gmail account to Sign in.
...
You can also view both your ETH balance and XCBC balance by clicking on “XCapital network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on XCapital”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to XCapital network.
