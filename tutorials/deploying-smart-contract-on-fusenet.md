...
XCapital is an EVM compatible network, every tool for Ethereum can be used for the XCapital network too.
...
Since we interact with remix using Metamask, you need to change the network to XCapital network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.xcscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) to do that.

You need to have a small balance of XCBC on the Fusenet wallet you are using which will be used as Gas for the transactions.
