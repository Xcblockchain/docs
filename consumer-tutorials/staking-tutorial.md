---
description: This tutorial will explain how to delegate/stake/unstake your XCBC.
---

# Staking tutorial

Note: You can only stake XCBC which is on XCapital network. Please make sure you have changed into XCapital network in Metamask while doing any transactions on staking UI. 

How to Stake XCapital:

**Step 1:**

Navigate to staking.xcscan.com and login to your wallet through metamask. Make sure you are on XCapital network. If you are not please follow the instructions [**here**](https://docs.xcscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of XCBC you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
