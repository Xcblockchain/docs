...
XCapital chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://xcscan.com/address/0x8D75cF8aB0a5Cf530E7Be3148d2E1BD480c43cD9) with the following params:
...
Some other useful functions on the [voting contract](https://xcscan.com/address/0x8D75cF8aB0a5Cf530E7Be3148d2E1BD480c43cD9) are:
