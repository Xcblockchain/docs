---
description: Steps to transfer/wrap XCBC20 tokens from Ethereum to Fusenet
---

# Bridge for XCBC20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/XCapital explorer to relay the tokens.
