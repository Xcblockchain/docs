...
The XCapital Studio REST API for accessing the data and the services of the XCapital network in a simple way. You can use this API to query and interact with the objects of the XCapital network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and XCapital network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(XCapital\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the XCapital network |
...
| homeBridgeAddress | `String` | Bridge address on the XCapital network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the XCapital network |
...
Community is a set of contracts and services. Members of the community are users of the XCapital network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the XCapital network |
| homeTokenAddress | `String` | Address of the community token on the XCapital network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the XCapital network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the XCapital network |
...
Entity is an account on the XCapital network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on XCapital network |
...
Tokens are compatible with the XCBC20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
